...
func ArticleCommentChildAdd(rid primitive.ObjectID, pid primitive.ObjectID, txt string, mid model.MIDTYPE, l_time time.Time, child_id primitive.ObjectID) error {
	//检测评论数据是否存在
